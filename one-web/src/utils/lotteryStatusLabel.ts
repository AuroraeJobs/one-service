...
const lotteryCodeText: Record<string, string> = {
  ...
  EXPERIMENTS: '策略实验',
  FAST: '快速',
  DATA_QUALITY_REFRESH: '数据质量刷新',
  LEDGER_ISSUES: '期次账本',
  LOTTERY_HEALTH_ACKNOWLEDGE: '健康确认',
  LOTTERY_HEALTH_GENERATE: '健康生成',
  LOTTERY_OUTCOME_ATTRIBUTION: '结果归因',
  LOTTERY_RECOMMENDATION_REFRESH: '推荐刷新',
  LOTTERY_RECOMMENDATION_STATUS: '推荐状态',
  LOTTERY_REMINDER_ACKNOWLEDGE: '提醒确认',
  LOTTERY_REMINDER_SNOOZE: '提醒稍后',
  LOTTERY_SIMULATION_RUN: '沙盘模拟',
  MANUAL: '手动',
  PORTFOLIO: '组合',
  PREDICTION: '预测',
  PREDICTIONS: '预测快照',
