...
import { CaretLeftOutlined, CaretRightOutlined, StepBackwardOutlined, StepForwardOutlined, CloudSyncOutlined } from '@ant-design/icons';
...
const RecordList: React.FC<RecordListProps> = () => {
  ...
  return (
    <div className="themed-route-page lottery-records-page">
      {/* 记录列表 */}
      <div className="lottery-records-list-card">
      ...
      {/* 筛选栏 */}
      <div className="lottery-record-filter-bar">
        {/* 所有元素统一居中容器 */}
