    ...
    >
      ...
      <div className="lottery-hot-number-content">
        ...
        <div className="lottery-hot-number-copy">
          <strong>{item ? t('出现 {{count}} 次', { count: item.count }) : t('暂无出现记录')}</strong>
  ...
  return (
    <MetricGrid gap={16} minColumnWidth={190}>
      <NumberFrequencyCard
        ...
        description={item => t('{{number}} 号是全历史出现最多的红球', { number: item.number })}
        emptyText={t('同步数据后显示热门红球')}
      />
      <NumberFrequencyCard
        title={t('冷红球')}
        ...
        accent="#ff3b30"
        ballClassName="lottery-hot-number-ball-red"
        description={item => t('{{number}} 号是全历史出现最少的红球', { number: item.number })}
        emptyText={t('同步数据后显示冷门红球')}
      />
      <NumberFrequencyCard
        title={t('热蓝球')}
        ...
        description={item => t('{{number}} 号是全历史出现最多的蓝球', { number: item.number })}
        emptyText={t('同步数据后显示热门蓝球')}
      />
      <NumberFrequencyCard
        title={t('冷蓝球')}
