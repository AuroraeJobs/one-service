...
const HealthMainPage: React.FC = () => {
  ...
  return (
    <div className="health-main-page" style={{ 
        ...
        {/* 主要内容区域 */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '24px', transformStyle: 'preserve-3d', perspective: '1200px' }}>
