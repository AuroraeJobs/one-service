...
- Link the month-end evidence-quality candidate to a focused attribution view.
- Summarize stable, watch, under-tested, and negative evidence-quality rows from the current rollup.
- Keep the first slice frontend-derived from existing outcome attribution rollups.

Status: completed with `/lottery/outcomes?focus=evidence-quality` and a focused evidence-quality summary on the attribution page.
