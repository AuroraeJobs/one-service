...
public class ThirdPartyUserBindingController {
    ...
    public ThirdPartyUserBinding findById(@PathVariable String id) {
    ...
    public List<ThirdPartyUserBinding> findByProvider(@PathVariable ThirdPartyProvider provider) {
    ...
    public List<ThirdPartyUserBinding> findByAccountKey(@PathVariable String accountKey) {
    ...
    public List<ThirdPartyUserBinding> findByLocalUserId(@PathVariable String localUserId) {
    ...
    public ThirdPartyUserBinding findByProviderAndThirdPartyUserId(@RequestParam ThirdPartyProvider provider,
