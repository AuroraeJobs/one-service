...
public class TeslaFleetController {
    ...
    public String authorizeUrl(@RequestParam(required = false) String state,
    ...
    public TeslaFleetTokenResponse saveToken(@RequestParam(required = false) String accountKey,
    ...
    public TeslaFleetTokenResponse refreshStoredToken(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetTokenStatus getTokenStatus(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetTokenCache getStoredToken(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetTokenResponse partnerToken(@RequestParam(required = false) String scope) {
    ...
    public TeslaFleetVehicleCache getCachedVehicles(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetVehicleCache refreshCachedVehicles(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetChargingHistoryCache getCachedChargingHistory(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetApiCache getApiCache(@RequestParam(required = false) String accountKey,
    ...
    public TeslaFleetApiCache refreshUserMeCache(@RequestParam(required = false) String accountKey) {
    ...
    public Map<String, Object> userMeWithStoredToken(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetApiCache refreshUserRegionCache(@RequestParam(required = false) String accountKey) {
    ...
    public TeslaFleetApiCache refreshVehicleCache(@RequestParam(required = false) String accountKey,
    ...
    public TeslaFleetApiCache refreshVehicleDataCache(@RequestParam(required = false) String accountKey,
                                                      @PathVariable String vin) {
    ...
    public TeslaFleetApiCache refreshNearbyChargingSitesCache(@RequestParam(required = false) String accountKey,
                                                              @PathVariable String vin) {
    ...
    public TeslaFleetApiCache refreshChargingInvoiceCache(@RequestParam(required = false) String accountKey,
                                                          @PathVariable String invoiceId) {
    ...
    public Map<String, Object> vehicleCommand(@RequestParam(required = false) String accountKey,
                                              @PathVariable String vin,
    ...
    public Map<String, Object> createFleetTelemetryConfig(@RequestParam(required = false) String accountKey,
                                                          @RequestBody(required = false) Map<String, Object> body) {
    ...
    public Map<String, Object> getFleetTelemetryConfig(@RequestParam(required = false) String accountKey,
                                                       @PathVariable String vin) {
    ...
    public Map<String, Object> deleteFleetTelemetryConfig(@RequestParam(required = false) String accountKey,
                                                          @PathVariable String vin) {
    ...
    public Map<String, Object> fleetTelemetryErrors(@RequestParam(required = false) String accountKey,
                                                    @PathVariable String vin) {
    ...
    public TeslaFleetTelemetryCache getFleetTelemetryCache(@PathVariable String vin,
                                                           @RequestParam(defaultValue = "V") String recordType) {
