...
public class LotteryRecordController {
    ...
    @Operation(summary = "删除开奖记录同步日志", description = "按日志 ID 删除一条非运行中的开奖记录同步日志")
    public void deleteSyncLog(@PathVariable("id") String id) {
        log.info("Deleting lottery record sync log: {}", id);
